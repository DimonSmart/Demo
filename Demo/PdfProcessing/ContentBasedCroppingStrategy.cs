...
internal static class ContentBasedCroppingStrategy
{
    ...
    private sealed class ContentBoundingBoxCollector(Rectangle pageBox, bool excludeEdgeTouchingObjects, double edgeExclusionTolerance, CancellationToken ct) : IEventListener
    {
        private const double DefaultEdgeExclusionTolerance = 1.0;
        ...
        private readonly double _edgeExclusionTolerance = edgeExclusionTolerance <= 0 ? DefaultEdgeExclusionTolerance : edgeExclusionTolerance;
