...
- **Число разрешённых сплитов и респлит тузов.** Сейчас лимит хранится в константе `MaxHandsAfterSplit`; его можно перенести в `BlackjackRulesOptions` и добавить отдельный флаг `AllowResplitAces`, который проверяется перед вызовом `SplitAsync`.【F:Demo/Demos/BJ/BlackjackGameBase.cs†L16-L21】【F:Demo/Demos/BJ/BlackjackGameBase.cs†L119-L144】
